...
namespace HungApple.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(HungAppleContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Delivery != null ? 
                          ...
                          Problem("Entity set 'HungAppleContext.Delivery'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HungAppleContext.Delivery'  is null.");
            }
            var delivery = await _context.Delivery.FindAsync(id);
            if (delivery != null)
            {
